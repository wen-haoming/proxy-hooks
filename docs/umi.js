(function (e) {
      ...
      try {
        for (
          ...
          if (null !== u) {
            ...
            (n = t.unstable_now()),
              'function' === typeof l ? (P.callback = l) : P === T(R) && A(R),
              D(n);
          } else A(R);
          P = T(R);
        }
      ...
      (t.unstable_scheduleCallback = function (e, n, i) {
        ...
        return (
          ...
          l > u
            ? ((e.sortIndex = l),
              O(I, e),
              null === T(R) && e === T(I) && (M ? a() : (M = !0), o(F, l - u)))
                  ...
                  if (e.state.currentSlug) {
                    ...
                    t &&
                      (document.documentElement.scrollTop =
                        C(t, document.documentElement) - 100);
                  }
                    ...
                    ('*' === k &&
                      'zh-CN' ===
                        (null === (t = m[0]) || void 0 === t
                          ? void 0
                          : t.name)),
                  P = new Date(O.updatedTime),
                  C = { github: 'GitHub', gitlab: 'GitLab' }[
                    (null === (n = (v || '').match(/(github|gitlab)/)) ||
                    void 0 === n
                      ? void 0
                      : n[1]) || 'nothing'
                  ];
          ...
          [
            {
              ...
              value: function (e) {
                for (
                  ...
                  var v = (o[h] || { name: '' }).name;
                  if (i.pathname.startsWith('/'.concat(v))) {
                    f.currentLocale = v;
                    break;
                  }
                }
                if (
                  ...
                  for (var m = a[f.currentLocale].length - 1; m >= 0; m -= 1) {
                    var g = a[f.currentLocale][m],
                      y = [g].concat(g.children).filter(Boolean),
                      b = y.find(function (e) {
                        return (
                          e.path &&
                          new RegExp(
    ...
    var r = n('VCU9'),
      ...
      u = function () {
        ...
        return r['a'].applyPlugins({
          ...
          initialValue: () =>
            Object(i['renderClient'])({
              routes: n('5eRu').routes,
              plugin: r['a'],
                    ...
                    if (!(E instanceof l)) {
                      ...
                      if (x) {
                        ...
                        var R = E.slice(0, k),
                          I = E.slice(S),
                          j = [b, _];
                        R && (++b, (w += R.length), j.push(R));
                        var P = new l(c, d ? t.tokenize(x, d) : x, g, x, v);
                        if (
                          (j.push(P),
                          I && j.push(I),
                          Array.prototype.splice.apply(n, j),
                ...
                for (var n = 0, r = e.length; n < r; n++) {
                  ...
                  if ('code' === o.type) {
                    ...
                    if (
                      ...
                      var u =
                        'language-' +
                        a.content.trim().split(/\s+/)[0].toLowerCase();
                      i.alias
        ...
        e.apply(this, n),
          ...
          s(this, 'getLineProps', function (e) {
            var n = e.key,
              r = e.className,
              o = e.style,
              a = g(e, ['key', 'className', 'style', 'line']),
              i = a,
              u = f({}, i, {
          ...
          s(this, 'getTokenProps', function (e) {
            var n = e.key,
              ...
              o = e.style,
              a = e.token,
              i = g(e, ['key', 'className', 'style', 'token']),
              u = i,
              l = f({}, u, {
              ...
              var t,
                ...
                d = {
                  files: y(
                    ...
                    b(t, 'demo.'.concat(p), { content: r.tsx || r.jsx }),
                    b(t, 'index.'.concat(p), {
                  ...
                  devDependencies: f ? { typescript: '^3.8.0' } : {},
                  desc: (0, o['default'])(i),
                  template: 'create-react-app'.concat(f ? '-typescript' : ''),
                  fileName: 'demo.'.concat(p),
                };
              e.setState({
                CSBData: (0, u['default'])(d, { name: l || 'dumi-demo' })
                  .parameters,
              });
            }),
            ...
            },
            {
              ...
              value: function () {
                var e,
                  ...
                  _ = S.currentFile,
                  R = f[T],
                  I = Boolean(Object.keys(x).length),
                  j = _ ? _.match(/\.(\w+)$/)[1] : T;
                return m
                  ? s
                  : r['default'].createElement(
                      ...
                      r['default'].createElement(
                        'div',
                        {
                          ...
                          style: {
                            transform: g ? 'translate(0, 0)' : void 0,
                            padding: b ? '0' : void 0,
                            background: y,
                          },
                        },
  ...
  '5eRu': function (e, t, n) {
    ...
    var r = n('k1fw'),
      ...
      a = n('VCU9'),
      i = [
        { path: '/_demos/demo1', component: n('B0Gy').default, exact: !0 },
        { path: '/_demos/index', component: n('MzAw').default, exact: !0 },
        {
          path: '/',
          component: (e) =>
                      ...
                      '*': {
                        '*': [
                          { path: '/', title: 'Home', meta: {} },
                          {
                            ...
                            children: [
                              {
                                path: '/reactivity/use-reactive',
                                title: 'useReactivity',
                                meta: { order: 0 },
                              },
                              {
                                path: '/reactivity/use-computed',
                                title: 'useComputed',
                                meta: {},
                              },
                            ],
                        ...
                        '/hooks': [
                          {
                            ...
                            children: [
                              {
                                path: '/hooks/advanced/use-creation',
                                title: 'useCreation',
                                meta: {},
                              },
                            ],
          ...
          routes: [
            {
              path: '/',
              component: n('S7jj').default,
              exact: !0,
              meta: {
                filePath: 'page_docs/index.md',
                updatedTime: 1594862607354,
                slugs: [
                  { depth: 1, value: 'Home', heading: 'home' },
                  {
                    depth: 2,
                    value:
            ...
            {
              path: '/reactivity/use-computed',
              component: n('UH5f').default,
              exact: !0,
              meta: {
                filePath: 'packages/vhooks/src/useComputed/index.md',
                updatedTime: 1594862242e3,
                title: 'useComputed',
                group: { title: 'useComputed', path: '/reactivity' },
                slugs: [],
              },
              title: 'useComputed',
            },
            {
              path: '/hooks/advanced/use-creation',
              component: n('PsVj').default,
              exact: !0,
              meta: {
                filePath: 'packages/vhooks/src/useCreation/index.en-US.md',
                updatedTime: 1594862242e3,
                title: 'useCreation',
                nav: { title: 'Hooks', path: '/hooks' },
                group: {
                  title: 'Advanced',
                  path: '/hooks/advanced',
                  order: 15,
                ...
                slugs: [
                  { depth: 1, value: 'useCreation', heading: 'usecreation' },
                  { depth: 2, value: 'Examples', heading: 'examples' },
                  { depth: 2, value: 'API', heading: 'api' },
                  { depth: 3, value: 'Params', heading: 'params' },
                ],
                locale: 'en-US',
              },
              title: 'useCreation',
            ...
            {
              path: '/reactivity/use-reactive',
              component: n('NPXT').default,
              exact: !0,
              meta: {
                filePath: 'packages/vhooks/src/useReactive/index.md',
                updatedTime: 1594862242e3,
                title: 'useReactivity',
                order: 0,
                group: { title: 'reactivity', path: '/reactivity' },
                slugs: [
                  { depth: 2, value: 'useReactive', heading: 'usereactive' },
                  {
                    depth: 2,
                    value: '\u4ee3\u7801\u6f14\u793a',
                    heading: '\u4ee3\u7801\u6f14\u793a',
                  ...
                  { depth: 2, value: 'API', heading: 'api' },
                  { depth: 2, value: 'initialState', heading: 'initialstate' },
                  { depth: 2, value: 'options', heading: 'options' },
                ],
              },
              title: 'useReactivity',
            },
            {
              ...
              meta: {},
              exact: !0,
              redirect: '/reactivity/use-reactive',
            },
            {
              path: '/hooks/advanced',
              meta: { order: 15 },
              exact: !0,
              redirect: '/hooks/advanced/use-creation',
            },
            {
              path: '/hooks',
              meta: {},
              exact: !0,
              redirect: '/hooks/advanced',
            },
            {
              path: '/advanced/use-creation',
              exact: !0,
              redirect: '/hooks/advanced/use-creation',
            },
          ],
  ...
  '5s+n': function (e, t, n) {
    ...
    var r,
        ...
        if (!t.notified) {
          ...
          O(function () {
            ...
            while (r.length > i) {
              ...
              try {
                f
                  ? (a || (t.rejection === ee && le(e, t), (t.rejection = J)),
                    !0 === f
                      ? (u = o)
      ...
      ie = function (e, t) {
        S.call(c, function () {
          ...
          if (
            o &&
            ((n = R(function () {
              G ? z.emit('unhandledRejection', r, e) : ae(K, e, r);
            })),
      ...
      le = function (e, t) {
        S.call(c, function () {
          G ? z.emit('rejectionHandled', e) : ae(Y, e, t.value);
        });
      },
      ce = function (e, t, n, r) {
        return function (o) {
  ...
  '67WC': function (e, t, n) {
    ...
    if ((!A || !x || x === k) && ((x = E.prototype), A))
      for (r in R) i[r] && h(i[r].prototype, x);
    if ((A && d(w) !== x && h(w, x), a && !l(x, O)))
      for (r in ((_ = !0),
      p(x, O, {
        get: function () {
    ...
    (function (t) {
      ...
      function y(e, t, r) {
        ...
        function h(t) {
          var n = o,
            r = a;
          return (o = a = void 0), (s = t), (u = e.apply(r, n)), u;
        }
        function y(e) {
        ...
        function S(e) {
          return (l = void 0), d && o ? h(e) : ((o = a = void 0), u);
        }
        function O() {
          void 0 !== l && clearTimeout(l), (s = 0), (o = c = a = l = void 0);
        }
        function T() {
        ...
        function A() {
          ...
          if (((o = arguments), (a = this), (c = e), n)) {
            ...
            if (p) return (l = setTimeout(k, t)), h(c);
          }
  ...
  JHO3: function (e, t, n) {
    e.exports = n.p + 'static/pic2.050a9cdd.png';
  },
  JMDn: function (e, t, n) {},
  JTJg: function (e, t, n) {
    'use strict';
      ...
      z = function (e) {
        ...
        for (n = [], r = 0; r < t; r++) {
          ...
          if (
            ...
            if (!(10 == a ? L : 8 == a ? N : M).test(o)) return e;
            i = parseInt(o, a);
          }
          n.push(i);
        }
      ...
      Ae = function (e, t, n, o) {
        ...
        while (s <= a.length) {
          switch (((i = a[s]), c)) {
            ...
            case xe:
              if (X(e)) {
                if (((c = ke), '/' != i && '\\' != i)) continue;
              } else if (n || '?' != i)
                if (n || '#' != i) {
                  if (i != r && ((c = ke), '/' != i)) continue;
    ...
    if (
      (a &&
        l(Re, {
          ...
          origin: ze(je),
          protocol: ze(Pe, function (e) {
            var t = k(this);
            Ae(t, String(e) + ':', ie);
          }),
          username: ze(Ce, function (e) {
            var t = k(this),
              n = d(String(e));
            if (!ee(t)) {
              t.username = '';
  ...
  LtsZ: function (e, t, n) {
    ...
    var y = m(function (e, t) {
      ...
      return (u.ref = (v !== m && t) || n), l.a.createElement('a', u);
    });
    var b = m(function (e, t) {
        ...
        return l.a.createElement(a['h'].Consumer, null, function (e) {
          e || Object(p['a'])(!1);
          var n = e.history,
            a = h(d(i, e.location), e.location),
            f = a ? n.createHref(a) : '',
            g = Object(s['a'])({}, c, {
              href: f,
              navigate: function () {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                switch (
                  ...
                  case k.compose:
                    return function () {
                      return H({ fns: u.concat(r), args: a })();
                    };
                }
              },
            },
    ...
    function ee(e, t) {
      ...
      var i = function (e, t) {
          o();
          var a = l.a.useContext(G),
            i = Object(O['useSubscription'])(r);
          return (
  ...
  MzAw: function (e, t, n) {
    ...
    (p = {}),
      Object(d['a'])(p, 1, 'TEXT'),
      Object(d['a'])(p, 2, 'CLASS'),
      Object(d['a'])(p, 4, 'STYLE'),
      Object(d['a'])(p, 8, 'PROPS'),
      Object(d['a'])(p, 16, 'FULL_PROPS'),
      Object(d['a'])(p, 32, 'HYDRATE_EVENTS'),
      Object(d['a'])(p, 64, 'STABLE_FRAGMENT'),
      Object(d['a'])(p, 128, 'KEYED_FRAGMENT'),
      Object(d['a'])(p, 256, 'UNKEYED_FRAGMENT'),
      Object(d['a'])(p, 1024, 'DYNAMIC_SLOTS'),
      Object(d['a'])(p, 512, 'NEED_PATCH'),
      Object(d['a'])(p, -1, 'HOISTED'),
      Object(d['a'])(p, -2, 'BAIL');
    var b,
      w = {},
      E = Object.assign,
    ...
    function z(e, t) {
      var n = function () {
        if (!n.active) return t.scheduler ? void 0 : e.apply(void 0, arguments);
        if (!M.includes(n)) {
          H(n);
          try {
            return G(), M.push(n), (b = n), e.apply(void 0, arguments);
          } finally {
            M.pop(), $(), (b = M[M.length - 1]);
          }
        }
      };
      return (
    ...
    function K(e, t, n) {
      if (W && void 0 !== b) {
        ...
        r || L.set(e, (r = new Map()));
        var o = r.get(n);
        o || r.set(n, (o = new Set())), o.has(b) || (o.add(b), b.deps.push(o));
      }
    }
    function Y(e, t, n, r, o, a) {
      ...
      if (i) {
        ...
        if ('clear' === t) i.forEach(l);
          ...
          void 0 !== n && l(i.get(n));
          var c = 'add' === t || ('delete' === t && !S(e));
          (c || ('set' === t && e instanceof Map)) &&
            l(i.get(S(e) ? 'length' : D)),
            c && e instanceof Map && l(i.get(F));
        }
        var s = function (e) {
    ...
    function ne() {
      ...
      return function (n, r, o) {
        ...
        if (
          '__v_raw' === r &&
          o === (e ? n['__v_readonly'] : n['__v_reactive'])
        )
          return n;
        var a = S(n);
        if (a && k(te, r)) return Reflect.get(te, r, o);
        var i = Reflect.get(n, r, o);
        return (O(r) ? Z.has(r) : '__proto__' === r || '__v_isRef' === r)
          ? i
          : (e || K(n, 'get', r),
            t ? i : Ue(i) ? (a ? i : i.value) : T(i) ? (e ? Me(i) : Le(i)) : i);
      };
    }
    ['includes', 'indexOf', 'lastIndexOf'].forEach(function (e) {
      te[e] = function () {
        for (var t = Fe(this), n = 0, r = this.length; n < r; n++)
          K(t, 'get', n + '');
        for (var o = arguments.length, a = new Array(o), i = 0; i < o; i++)
          a[i] = arguments[i];
        var u = t[e].apply(t, a);
        return -1 === u || !1 === u ? t[e].apply(t, g(a.map(Fe))) : u;
      };
    });
    var re = ae(),
      oe = ae(!0);
    function ae() {
      ...
      return function (t, n, r, o) {
        var a = t[n];
        if (!e && ((r = Fe(r)), !S(t) && Ue(a) && !Ue(r)))
          return (a.value = r), !0;
        var i = k(t, n),
          u = Reflect.set(t, n, r, o);
        return (
          t === Fe(o) &&
            (i ? C(r, a) && Y(t, 'set', n, r, a) : Y(t, 'add', n, r)),
          u
        );
      };
    }
    ...
    function le(e) {
      return K(e, 'iterate', D), Reflect.ownKeys(e);
    }
    var ce = { get: Q, set: re, deleteProperty: ie, has: ue, ownKeys: le },
      se = {
        get: J,
        has: ue,
        ownKeys: le,
    ...
    function me(e) {
      var t = Fe(this),
        n = Fe(e);
      e !== n && K(t, 'has', e), K(t, 'has', n);
      var r = he(t).has;
      return r.call(t, e) || r.call(t, n);
    }
    function ge(e) {
      return (e = Fe(e)), K(e, 'iterate', D), Reflect.get(he(e), 'size', e);
    }
    function ye(e) {
      e = Fe(e);
      var t = Fe(this),
    ...
    function be(e, t) {
      ...
      var n = Fe(this),
        ...
        i = r.set,
        u = o.call(n, e);
      u || ((e = Fe(e)), (u = o.call(n, e)));
      var l = a.call(n, e),
        c = i.call(n, e, t);
      return u ? C(t, l) && Y(n, 'set', e, t, l) : Y(n, 'add', e, t), c;
    }
    function we(e) {
      var t = Fe(this),
        n = he(t),
        ...
        a = n['delete'],
        i = r.call(t, e);
      i || ((e = Fe(e)), (i = r.call(t, e)));
      var u = o ? o.call(t, e) : void 0,
        l = a.call(t, e);
      return i && Y(t, 'delete', e, void 0, u), l;
    }
    function Ee() {
      var e = Fe(this),
        t = 0 !== e.size,
    ...
    function xe(e, t) {
      return function (n, r) {
        var o = this,
          ...
          i = e ? pe : t ? de : fe;
        function u(e, t) {
          return n.call(r, i(e), i(t), o);
        }
        return !e && K(a, 'iterate', D), he(a).forEach.call(a, u);
      };
    }
    function ke(e, t, n) {
      return function () {
          ...
          Object(d['a'])(
            {
              next: function () {
                ...
                return n
                  ? { value: t, done: n }
                  : { value: a ? [f(t[0]), f(t[1])] : f(t), done: n };
              },
            },
            Symbol.iterator,
            function () {
    ...
    var Oe = {
      ...
      _e = ['keys', 'values', 'entries', Symbol.iterator];
    function Re(e, t) {
      var n = t ? Te : e ? Ae : Oe;
      return function (t, r, o) {
        return '__v_isReactive' === r
          ...
          : '__v_raw' === r
          ? t
          : Reflect.get(k(n, r) && r in t ? n : t, r, o);
      };
    }
    _e.forEach(function (e) {
      (Oe[e] = ke(e, !1, !1)), (Ae[e] = ke(e, !0, !1)), (Te[e] = ke(e, !1, !0));
    });
    var Ie = { get: Re(!1, !1) },
      je = (Re(!1, !0), { get: Re(!0, !1) });
    var Pe = new Set([Set, Map, WeakMap, WeakSet]),
      Ce = y('Object,Array,Map,Set,WeakMap,WeakSet'),
      Ne = function (e) {
        return !e['__v_skip'] && Ce(R(e)) && !Object.isFrozen(e);
      };
    function Le(e) {
      return e && e['__v_isReadonly'] ? e : De(e, !1, ce, Ie);
    }
    function Me(e) {
      return De(e, !0, se, je);
    }
    function De(e, t, n, r) {
      ...
      if (k(e, t ? '__v_readonly' : '__v_reactive'))
        return t ? e['__v_readonly'] : e['__v_reactive'];
      if (!Ne(e)) return e;
      var o = new Proxy(e, Pe.has(e.constructor) ? r : n);
      return N(e, t ? '__v_readonly' : '__v_reactive', o), o;
    }
    function Fe(e) {
    ...
    function Be(e, t) {
      var n = Object(r['useRef'])({ deps: t, obj: void 0, initialized: !1 }),
        o = n.current;
      return (
        (!1 !== o.initialized && qe(o.deps, t)) ||
          ((o.deps = t), (o.obj = e()), (o.initialized = !0)),
        o.obj
      );
    }
    function qe(e, t) {
    ...
    function Ge(e) {
      if ('object' === typeof e)
        for (var t in e) 'object' === typeof e && Ge(e[t]);
    }
    function $e(e) {
      var t =
        ...
        h = d.current,
        v = Be(() => Le(s), []),
        m = Be(() => He()(() => p(Object(a['a'])({}, v)), o), []),
        g = Be(() => Ve()(() => p(Object(a['a'])({}, v)), u), []);
      return (
        Object(r['useEffect'])(
          () => (
            B(() => {
    ...
    var Ke = () => {
      var e = $e({ count: 0, val: { val1: { val2: '' } } }),
        t = $e({ val: '' }, { debounce: 300 }),
        n = $e({ val: '' }, { throttle: 500 });
      return o.a.createElement(
        ...
        o.a.createElement('input', {
          ...
          type: 'text',
          onChange: (t) => {
            e.val.val1.val2 = t.target.value;
          },
        }),
        o.a.createElement(
          'p',
        ...
        o.a.createElement('input', {
          ...
          type: 'text',
          onChange: (e) => {
            n.val = e.target.value;
          },
        }),
      );
    };
    t['default'] = Object(r['memo'])(Ke);
  },
  'N+g0': function (e, t, n) {
    var r = n('g6v/'),
      o = n('m/L8'),
      ...
      return a.a.createElement(
        ...
        a.a.createElement(
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              'a',
              { 'aria-hidden': 'true', href: '#usereactive' },
        ...
        a.a.createElement(
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              'a',
              { 'aria-hidden': 'true', href: '#initialstate' },
              a.a.createElement('span', { className: 'icon icon-link' }),
            ),
            'initialState',
          ),
          a.a.createElement(
            ...
            a.a.createElement(
              ...
              a.a.createElement(
                'tr',
                null,
                a.a.createElement('td', null, 'initialState'),
                a.a.createElement(
                  'td',
                  null,
                  '\u5f53\u524d\u7684\u6570\u636e\u5bf9\u8c61',
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              ...
              a.a.createElement(
                'tr',
                null,
                a.a.createElement('td', null, 'debounce'),
                a.a.createElement(
                  'td',
                  null,
                  '\u9632\u6296\u7684\u6beb\u79d2\u6570',
              ...
              a.a.createElement(
                'tr',
                null,
                a.a.createElement('td', null, 'throttle'),
                a.a.createElement(
                  'td',
                  null,
                  '\u8282\u6d41\u7684\u6beb\u79d2\u6570',
      ...
      return a.a.createElement(
        ...
        a.a.createElement(
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              'a',
              { 'aria-hidden': 'true', href: '#usecreation' },
              a.a.createElement('span', { className: 'icon icon-link' }),
            ),
            'useCreation',
          ),
          a.a.createElement(
            'p',
            null,
            a.a.createElement('code', null, 'useCreation'),
            ' is the replacement for ',
            a.a.createElement('code', null, 'useMemo'),
            ' or ',
            a.a.createElement('code', null, 'useRef'),
            '.',
          ),
          a.a.createElement(
            'p',
            null,
            a.a.createElement('code', null, 'useMemo'),
            " can't guarantee the memoized value will not be recalculated, while ",
            a.a.createElement('code', null, 'useCreation'),
            ' can guarantee that. As the the official document of React.js says:',
          ),
          a.a.createElement(
            'blockquote',
            null,
          ...
          a.a.createElement(
            ...
            ', you can use ',
            a.a.createElement('code', null, 'useCreation'),
            ' to create some constants. But ',
            a.a.createElement('code', null, 'useCreation'),
            ' can avoid performance hazards.',
          ),
          a.a.createElement(u.a, {
            code:
        ...
        a.a.createElement(
          ...
          Object(r['a'])(
            ...
            { path: '/_demos/demo1', dependencies: {}, files: {} },
          ),
          a.a.createElement(s, null),
        ),
        a.a.createElement(
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              ...
              a.a.createElement(
                'tr',
                null,
                a.a.createElement('th', null, 'Property'),
                a.a.createElement('th', null, 'Description'),
                a.a.createElement('th', null, 'Type'),
                a.a.createElement('th', null, 'Default'),
              ),
            ),
            a.a.createElement(
              'tbody',
              ...
              a.a.createElement(
                'tr',
                null,
                a.a.createElement('td', null, 'factory'),
                a.a.createElement(
                  'td',
                  null,
                  'A function used for creating the object.',
                ),
                a.a.createElement('td', null, '() => any'),
                a.a.createElement('td', null, '-'),
              ),
              a.a.createElement(
                'tr',
                null,
                a.a.createElement('td', null, 'deps'),
                a.a.createElement('td', null, 'The dependencies list.'),
                a.a.createElement('td', null, 'any[]'),
                a.a.createElement('td', null, '-'),
              ),
            ),
  ...
  R2QN: function (e, t, n) {
    ...
    var f = function (e, t) {
      ...
      var s = t,
        ...
        d = s.name,
        h = s.template,
        v = void 0 === h ? 'create-react-app' : h,
        m = t,
        g = m.main,
        y = u(u({}, a), p);
      (g =
        g || 'create-react-app-typescript' !== v ? 'index.jsx' : 'index.tsx'),
        c(y);
      var b = u(
          u({}, n),
          {},
          {
            'package.json': { content: (0, o.newpkgJSON)(y, d, g, i || {}, l) },
            'sandbox.config.json': { content: JSON.stringify({ template: v }) },
          },
          f,
        ),
      ...
      return o.a.createElement(
        ...
        o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              'a',
              { 'aria-hidden': 'true', href: '#home' },
              o.a.createElement('span', { className: 'icon icon-link' }),
            ),
            'Home',
          ),
          o.a.createElement(i.a, {
            code: 'npm i v-reactive-hooks --save\n',
            lang: 'bash',
          }),
          o.a.createElement(
            'h2',
          ...
          o.a.createElement(
            'p',
            null,
            o.a.createElement('img', { src: n('vXUn') }),
          ),
          o.a.createElement(
            'p',
            null,
            o.a.createElement('img', { src: n('JHO3') }),
          ),
        ),
      );
    };
  ...
  Ty5D: function (e, t, n) {
    ...
    function C(e, t) {
      ...
      return s.reduce(function (t, n) {
        if (!n && '' !== n) return null;
        if (t) return t;
        var r = P(n, { end: a, strict: u, sensitive: c }),
          o = r.regexp,
          i = r.keys,
          l = o.exec(e);
        if (!l) return null;
            ...
            return (
              a.a.Children.forEach(e.props.children, function (e) {
                if (null == r && a.a.isValidElement(e)) {
                  ...
                  r = i
                    ? C(o.pathname, Object(c['a'])({}, e.props, { path: i }))
                    : t.match;
                }
              }),
      ...
      return [
        ...
        function (e, r) {
          ...
          for (var O = '', T = 0, A = 0; A < x.length; A++) {
            ...
            var P = k.groups;
            if (h) {
              var C = [_].concat(I, R, d);
              void 0 !== P && C.push(P);
              var N = String(r.apply(void 0, C));
            } else N = w(_, d, R, I, P, r);
  ...
  X7LM: function (e, t, n) {
    ...
    var r = 2147483647,
      ...
      w = function (e, t, n) {
        var r = 0;
        for (e = n ? m(e / l) : e >> 1, e += m(e / t); e > (v * i) >> 1; r += o)
          e = m(e / v);
      ...
      E = function (e) {
        ...
        while (x < l) {
          ...
          for (d += (k - p) * S, p = k, n = 0; n < e.length; n++) {
            ...
            if (u == p) {
              for (var O = d, T = o; ; T += o) {
                var A = T <= v ? a : T >= v + i ? i : T - v;
                if (O < A) break;
                var _ = O - A,
                  R = o - A;
                t.push(g(b(A + (_ % R)))), (O = m(_ / R));
              }
              t.push(g(b(O))), (v = w(d, S, x == E)), (d = 0), ++x;
            }
          }
          ++d, ++p;
        }
            ...
            if (n)
              if ((t.pushState({ key: i, state: l }, null, r), u))
                ...
                var c = F.indexOf(Z.location.key),
                  s = F.slice(0, c + 1);
                s.push(a.key), (F = s), x({ action: o, location: a });
              }
          ...
          if (e) {
            ...
            if (n)
              if ((t.replaceState({ key: i, state: l }, null, r), u))
                ...
                var c = F.indexOf(Z.location.key);
                -1 !== c && (F[c] = a.key), x({ action: o, location: a });
              }
        ...
        (V += e),
          1 === V && 1 === e
            ? (window.addEventListener(I, _),
              o && window.addEventListener(j, C))
            : 0 === V &&
              (window.removeEventListener(I, _),
              o && window.removeEventListener(j, C));
      }
      var $ = !1;
      function K(e) {
        void 0 === e && (e = !1);
      ...
      function z(e, t) {
        ...
        v.confirmTransitionTo(r, n, a, function (e) {
          if (e) {
            ...
            if (a) {
              (x = t), F(o);
              var i = B.lastIndexOf(w(X.location)),
                u = B.slice(0, i + 1);
    ...
    if (a) {
      ...
      (R = function (e) {
        ...
        (I = function (e, t, n) {
          ...
          if (((n = void 0 === n ? r - a : f(n)), a + n > r)) throw C(T);
  ...
  afO8: function (e, t, n) {
    ...
    e.exports = { set: r, get: o, has: a, enforce: h, getterFor: v };
  },
  apDx: function (e, t, n) {
    var r = n('dG/n');
    r('dispose');
  ...
  dOgj: function (e, t, n) {
    ...
    var r = n('I+eb'),
      ...
      Y = function (e, t) {
        return K(e, (t = v(t, !0))) ? s(2, e[t]) : P(e, t);
      },
      Z = function (e, t, n) {
          ...
          D
            ...
            : ((m = t(function (e, t, n, r) {
                ...
                if (y(t)) {
                  ...
                  if (void 0 === r) {
                    if (v % a) throw N(W);
                    if (((i = v - f), i < 0)) throw N(W);
                  } else if (((i = p(r) * a), i + f > v)) throw N(W);
                  l = i / a;
      ...
      if (
        (P &&
          ...
          h !== Object.prototype &&
            ...
            (f ||
              a(k) === h ||
              (i ? i(k, h) : 'function' != typeof k[m] && l(k, m, w)),
            u(k, A, !0, !0),
            f && (p[A] = w))),
        d == y &&
          I &&
        ...
        if (((S = { values: T(y), keys: E ? j : T(g), entries: T(b) }), x))
          for (O in S) (v || _ || !(O in R)) && c(R, O, S[O]);
  ...
  'hKI/': function (e, t, n) {
    (function (t) {
      ...
      function y(e, t, r) {
        ...
        function y(e) {
          return (s = e), (l = setTimeout(x, t)), f ? h(e) : u;
        }
        function b(e) {
          var n = e - c,
            r = e - s,
        ...
        concat: function (e) {
          ...
          for (t = -1, r = arguments.length; t < r; t++)
            if (((a = -1 === t ? i : arguments[t]), b(a))) {
              if (((o = l(a.length)), p + o > v)) throw TypeError(m);
  ...
  ogwx: function (e, t, n) {
    ...
    var i = Object({ NODE_ENV: 'production' }).__IS_SERVER
      ...
      u = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
        return e || (i = Object(o['a'])(a)), i;
      },
      l = function () {
        var e =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        a = Object(r['a'])(Object(r['a'])({}, a), e);
      };
  },
  or9q: function (e, t, n) {
    'use strict';
  ...
  pNMO: function (e, t, n) {
    ...
    G[q][z] || A(G[q], z, G[q].valueOf), M(G, B), (j[U] = !0);
  },
  pevA: function (e, t, n) {
    'use strict';
    var r = n('I+eb'),
        ...
        toFixed: function (e) {
          ...
          if ((l < 0 && ((h = '-'), (l = -l)), l > 1e-21))
            if (
              ...
              g(1 << r), m(1, 1), g(2), (v = y());
            } else m(0, n), m(1 << -t, 0), (v = y() + i.call('0', p));
          return (
            p > 0
              ? ((u = v.length),
                (v =
  ...
  vXUn: function (e, t, n) {
    e.exports = n.p + 'static/pic1.d20641c4.png';
  },
  vZi8: function (e, t, n) {
    var r = n('I+eb'),
      o = n('YGK4'),
  ...
  yl30: function (e, t, n) {
    ...
    function N() {
      if (I) {
        var e = I,
          t = j;
        if (((j = I = null), P(e), t)) for (e = 0; e < t.length; e++) P(t[e]);
      }
    }
    function L(e, t) {
      return e(t);
    ...
    function je(e, t) {
      ...
      t.hasOwnProperty('value')
        ? Ce(e, t.type, n)
        : t.hasOwnProperty('defaultValue') && Ce(e, t.type, ke(t.defaultValue)),
        null == t.checked &&
    ...
    function un(e, t, n, r) {
      if (tn)
        if (0 < Tt.length && -1 < Ct.indexOf(e))
          (e = Mt(null, e, t, n, r)), Tt.push(e);
        else {
          var o = ln(e, t, n, r);
          if (null === o) Dt(e, r);
          else if (-1 < Ct.indexOf(e)) (e = Mt(o, e, t, n, r)), Tt.push(e);
    ...
    function Lr(e) {
      if ('value' === e.propertyName && jr(Rr))
        if (((e = Ar(Rr, e, vt(e))), U)) ht(e);
        else {
          U = !0;
          try {
            L(Ir, e);
    ...
    var ja = ee.ReactCurrentBatchConfig,
    ...
    function Ma(e, t, n) {
      ...
      return (
        'object' === typeof a && null !== a
          ? (a = xa(a))
          : ((o = No(t) ? Po : Io.current),
            (r = t.contextTypes),
            (a = (r = null !== r && void 0 !== r) ? Co(e, o) : Ro)),
        (t = new t(n, a)),
        (e.memoizedState =
    ...
    function Fa(e, t, n, r) {
      var o = e.stateNode;
      (o.props = n), (o.state = e.memoizedState), (o.refs = Pa), Sa(e);
      var a = t.contextType;
      'object' === typeof a && null !== a
        ? (o.context = xa(a))
        : ((a = No(t) ? Po : Io.current), (o.context = Co(e, a))),
        Ra(e, n, o, r),
    ...
    function Za(e, t) {
      switch ((_o(Ka, t), _o($a, e), _o(Ga, Va), (e = t.nodeType), e)) {
        case 9:
        case 11:
    ...
    function pi(e, t, n, r, o, a) {
      if (
        ...
        (t.updateQueue = null),
        (t.expirationTime = 0),
        (ri.current = null === e || null === e.memoizedState ? Li : Mi),
        (e = n(r, o)),
        t.expirationTime === ai)
      ) {
        a = 0;
        ...
        do {
          ...
          if (s < ai) {
            ...
            null === l ? ((u = l = f), (a = r)) : (l = l.next = f),
              s > ii.expirationTime && ((ii.expirationTime = s), Dl(s));
          } else
            null !== l &&
              (l = l.next = {
                expirationTime: 1073741823,
    ...
    function yi(e) {
      ...
      return (
        ...
        (e = e.dispatch = Ci.bind(null, ii, e)),
        [t.memoizedState, e]
      );
    }
    function bi(e, t, n, r) {
    ...
    var Ni = {
      ...
      Li = {
        ...
        useTransition: function (e) {
          var t = yi(!1),
            n = t[0];
          return (t = t[1]), [Ri(Pi.bind(null, t, e), [t, e]), n];
        },
      },
      Mi = {
        readContext: xa,
        ...
        useTransition: function (e) {
          var t = mi(vi),
            n = t[0];
          return (t = t[1]), [Ii(Pi.bind(null, t, e), [t, e]), n];
        },
      },
      Di = {
        readContext: xa,
    ...
    function tu(e, t, n, r, o) {
      ...
      if ((Ea(t, o), null === t.stateNode))
        ...
        (i.state = p),
          Ra(t, r, i, o),
          (l = t.memoizedState),
          u !== r || p !== l || jo.current || ka
            ? ('function' === typeof s &&
                (Ca(t, n, s, r), (l = t.memoizedState)),
              (u = ka || La(t, n, u, r, p, l, c))
                ? (f ||
        ...
        (i = t.stateNode),
          ...
          Ra(t, r, i, o),
          (p = t.memoizedState),
          u !== r || l !== p || jo.current || ka
            ? ('function' === typeof s &&
                (Ca(t, n, s, r), (p = t.memoizedState)),
              (s = ka || La(t, n, u, r, l, p, c))
                ? (f ||
            ...
            if (((e = Ya(Ga.current)), Vi(t))) {
              ...
              switch (
                ...
                case 'details':
                  ...
                  break;
                case 'input':
                  Re(e, r), (c = _e(e, r)), nn('invalid', e), gn(n, 'onChange');
                  break;
                case 'option':
                  c = Le(e, r);
                  break;
    ...
    function mu(e) {
      switch (e.tag) {
        ...
        case 3:
          if ((Qa(), Ao(jo), Ao(Io), (t = e.effectTag), 0 !== (64 & t)))
            throw Error(i(285));
    ...
    function _l(e, t) {
      ...
      if (0 !== n) {
        if (((t = e.callbackNode), (Xu & (Wu | Vu)) !== zu))
          throw Error(i(327));
        if ((Gl(), (e === Ju && n === tl) || Cl(e, n), null !== el)) {
          var r = Xu;
          Xu |= Wu;
          var o = Ll();
          do {
          ...
          if ((ya(), (Xu = r), (Bu.current = o), nl === $u))
            throw ((t = rl), Cl(e, n), pc(e, n), Al(e), t);
          if (null === el)
            switch (
              ...
              case Yu:
                if (
                  ...
                  e.timeoutHandle = Cn(Hl.bind(null, e), o);
                  break;
                }
                Hl(e);
                break;
              case Zu:
                ...
                if (
                  ...
                  e.timeoutHandle = Cn(Hl.bind(null, e), r);
                  break;
                }
                Hl(e);
                break;
              case Qu:
                if (1073741823 !== ol && null !== il) {
                  ...
                  if (
                    ...
                    pc(e, n), (e.timeoutHandle = Cn(Hl.bind(null, e), r));
                    break;
                  }
                }
                Hl(e);
    ...
    function Rl(e) {
      ...
      if (((t = 0 !== t ? t : 1073741823), (Xu & (Wu | Vu)) !== zu))
        throw Error(i(327));
      if ((Gl(), (e === Ju && t === tl) || Cl(e, t), null !== el)) {
        var n = Xu;
        Xu |= Wu;
        var r = Ll();
        do {
        ...
        if ((ya(), (Xu = n), (Bu.current = r), nl === $u))
          throw ((n = rl), Cl(e, t), pc(e, t), Al(e), n);
    ...
    function Wl(e, t) {
      ...
      if ((Xu & (Wu | Vu)) !== zu) throw Error(i(327));
            ...
            for (u = e, l = t; null !== fl; ) {
              ...
              switch (1038 & w) {
                case 2:
                  ...
                  break;
                case 6:
                  Ru(fl), (fl.effectTag &= -3), Cu(fl.alternate, fl);
                  break;
                case 1024:
                  fl.effectTag &= -1025;
                  break;
                case 1028:
                  (fl.effectTag &= -1025), Cu(fl.alternate, fl);
                  break;
                case 4:
                  Cu(fl.alternate, fl);
                  break;
    ...
    function $l() {
      if (null === ml) return !1;
      var e = ml;
      if (((ml = null), (Xu & (Wu | Vu)) !== zu)) throw Error(i(331));
      var t = Xu;
    ...
    function Zl(e, t, n) {
      ...
      null !== r && r.delete(t),
        Ju === e && tl === n
          ? nl === Zu || (nl === Yu && 1073741823 === ol && oa() - cl < sl)
            ? Cl(e, tl)
            : (ll = !0)
          : fc(e, n) &&
            ((t = e.lastPingedTime),
    ...
    Fu = function (e, t, n) {
      ...
      if (null !== e) {
        ...
        if (e.memoizedProps !== o || jo.current) Ki = !0;
        else {
          if (r < n) {
            switch (((Ki = !1), t.tag)) {
              case 3:
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        ...
        case 5:
          return (
            ...
            Pn(r, o)
              ? (u = null)
              : null !== a && Pn(r, a) && (t.effectTag |= 16),
            Ji(e, t),
            4 & t.mode && 1 !== n && o.hidden
              ? ((t.expirationTime = t.childExpirationTime = 1), (t = null))
              : (Yi(e, t, u, n), (t = t.child)),
            t
          );
        case 6:
        ...
        case 4:
          return (
            Za(t, t.stateNode.containerInfo),
            (r = t.pendingProps),
            null === e ? (t.child = Ha(t, null, r, n)) : Yi(e, t, r, n),
            t.child
          );
        case 11:
          return (
        ...
        case 9:
          return (
            ...
            (r = a.children),
            Ea(t, n),
            (o = xa(o, a.unstable_observedBits)),
            (r = r(o)),
            (t.effectTag |= 1),
            Yi(e, t, r, n),
            t.child
    ...
    (function (e) {
      ...
      (t.flushSync = function (e, t) {
        if ((Xu & (Wu | Vu)) !== zu) throw Error(i(187));
        var n = Xu;
        Xu |= 1;
        try {
  ...
  zlVK: function (e, t, n) {
        ...
        return (
          u.Children.forEach(r, function (e) {
            if (null === i && u.isValidElement(e)) {
              ...
              i = r
                ? l.matchPath(a.pathname, v({}, e.props, { path: r }))
                : t.match;
            }
          }),
          i
    ...
    function T(e) {
      return u.createElement(l.__RouterContext.Consumer, null, function (t) {
        ...
        return u.createElement(
          ...
          { value: o },
          o.match ? a(v({}, e.layoutProps, {}, o)) : null,
        );
      });
    }
    function A(e, t) {
    ...
    function _(e) {
      var t = e.route,
        n = e.opts,
        r = e.props,
        o = I(v({}, n, { routes: t.routes || [], rootRoutes: n.rootRoutes })),
        a = t.component,
        i = t.wrappers;
      if (a) {
    ...
    function N(e) {
      var t = e.plugin.applyPlugins({
        type: l.ApplyPluginsType.modify,
        key: 'rootContainer',
        initialValue: u.createElement(j, {
          history: e.history,
          routes: e.routes,
          plugin: e.plugin,
          ssrProps: e.ssrProps,
